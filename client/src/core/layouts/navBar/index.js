...
//internal import 
import DarkThemeSwitch from '../../components/switchDarkMode';
...
export default function MiniDrawer({ children }) {
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <Box sx={{ display: 'flex' }}>
        <CssBaseline />
        <AppBar position="fixed" open={open}> {/* add props "enableColorOnDark" to use primary color with dark mode */}
            <Toolbar>
              <IconButton
                color="inherit"
              ...
              <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                <IconButton
                  ...
                  color="inherit"
                >
                  <DarkThemeSwitch checked={darkState} onChange={handleThemeChange} />
                </IconButton>
                <IconButton
                  size="large"
                  edge="end"
