...
const MainContents = () =>  (
    <Box sx={{ flexGrow: 1, mx: "10%" }}>
        ...
        <Typography variant="subtitle1" gutterBottom component="div">
            ...
            aenean sed adipiscing. Amet nisl suscipit adipiscing bibendum est ultricies integer quis. 
            Cursus euismod quis viverra nibh cras. Metus vulputate eu scelerisque felis imperdiet 
            proin fermentum leo. Mauris commodo quis imperdiet massa tincidunt. Cras tincidunt 
            obortis feugiat vivamus at augue. At augue eget arcu dictum varius duis at consectetur 
            lorem. Velit sed ullamcorper morbi tincidunt. Lorem donec massa sapien faucibus et molestie ac.
            </Typography>
        </Item>
        <Item elevation={0} sx={{ mx: { xs: 'auto', md: '25%' } }}>
            <img src={OneBristol} alt="illustration of a woman on a folder files"  width="100%"/>
        </Item>
        <Item elevation={0}>
            <Typography variant="subtitle1" gutterBottom component="div">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
        ...
        <Item elevation={0} sx={{ mx: { xs: 'auto', md: '25%' } }}>
            <img src={fileBundle} alt="illustration of a woman on a folder files"  width="100%"/>
        </Item>
        <Item elevation={0}>
        <Typography variant="subtitle1" gutterBottom component="div">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
        ...
        <Item elevation={0} sx={{ mx: { xs: 'auto', md: '25%' } }}>
            <img src={TeamSpirit} alt="illustration of a woman on a folder files"  width="100%"/>
        </Item>
        <Item elevation={0} >
        <Typography variant="subtitle1" gutterBottom component="div">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
